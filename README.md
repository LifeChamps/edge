...
Detailed instructions on setting up and using this repository for your Raspberry Pi-based Kubernetes setup can be found in the [Setup Guide](k8s-gitops/SETUP.md).
